...
@ApplicationScoped
public class DMNMarshallerImportsClientHelperKogito implements DMNMarshallerImportsClientHelper {
    ...
    private static final Logger LOGGER = Logger.getLogger(DMNMarshallerImportsClientHelperKogito.class.getName());
    ...
    @Inject
    public DMNMarshallerImportsClientHelperKogito(final KogitoResourceContentService contentService,
